...
logs_path = '/tmp/current_multitask_kl_latest'
class Answer_Generator():
    ...
    def build_model(self):
        ...
        final_loss=  cross_entropy+(25*KL)
...
#checkpoint_path = '../vqahat_model/san_lstm_att_multitask_new_split_oct29'
#checkpoint_path = '../vqahat_model/san_lstm_att_multitask_new_tensorboard'
...
def train():
    ...
    #vqadata=open('vqa_data.pkl')
    #train_data={}
    #train_data=pickle.load(newpval)
    #num_train = train_data['question'].shape[0]
    ...
    #this is for vqahat
    newpval=open('save_vqahat_train1.pkl')
