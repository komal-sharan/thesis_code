...
def test():
    ...
    with tf.device('/cpu:0'):
        ...
        #saver.restore(sess, '/home/ksharan1/visualization/san-vqa-tensorflow/vqahat_model/san_lstm_att_multitask_new_split_experiment_oct29/model-75000')
        saver.restore(sess, '/home/ksharan1/visualization/san-vqa-tensorflow/vqahat_model/san_lstm_att_multitask_new_split_oct29/model-75000')
    ...
    #pickle.dump(prob_att2_list, open("san_vis_new_dec1.pkl", "wb"))
    #pickle.dump(ques_ids, open("san_vis_new_quesid_list_dec1.pkl", "wb"))

    pickle.dump(prob_att2_list, open("san_vis_new_dec1_confirm.pkl", "wb"))
    pickle.dump(ques_ids, open("san_vis_new_quesid_list_dec1_confirm.pkl", "wb"))
