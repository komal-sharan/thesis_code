...
def test():
    ...
    with tf.device('/cpu:0'):
        ...
        saver.restore(sess, '/home/ksharan1/visualization/san-vqa-tensorflow/vqahat_model/san_lstm_att_multitask_new_split/model-75000')
    ...
    dd = json.dump(my_list,open('san_lstm_att_aftermoving_new.json','w'))
