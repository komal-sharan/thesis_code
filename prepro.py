...
def main(params):
    ...
    json.dump(imgs_train, open('test2.json', 'w'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', default='data_prepro_test.json', help='output json file')
    parser.add_argument('--output_h5', default='data_prepro_test.h5', help='output h5 file')
